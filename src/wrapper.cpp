...
PYBIND11_MODULE(seal, m)
{
    ...
    py::class_<EncryptionParameters>(m, "EncryptionParameters")
        ...
        .def_property("plain_modulus", &EncryptionParameters::plain_modulus, py::overload_cast<const Modulus &>(&EncryptionParameters::set_plain_modulus))
    ...
    py::class_<SEALContext::ContextData, std::shared_ptr<SEALContext::ContextData>>(m, "ContextData")
        ...
        .def_property_readonly("parms_id", &SEALContext::ContextData::parms_id)
        .def_property_readonly("qualifiers", &SEALContext::ContextData::qualifiers)
        .def_property_readonly("total_coeff_modulus", &SEALContext::ContextData::total_coeff_modulus)
    ...
    py::class_<SEALContext, std::shared_ptr<SEALContext>>(m, "SEALContext")
        ...
        .def_property_readonly("key_context_data", &SEALContext::key_context_data)
        .def_property_readonly("first_context_data", &SEALContext::first_context_data)
        .def_property_readonly("last_context_data", &SEALContext::last_context_data)
        .def_property_readonly("parameters_set", &SEALContext::parameters_set)
        .def_property_readonly("first_parms_id", &SEALContext::first_parms_id)
        .def_property_readonly("last_parms_id", &SEALContext::last_parms_id)
        .def_property_readonly("using_keyswitching", &SEALContext::using_keyswitching)
        ;

    // modulus.h
    py::class_<Modulus>(m, "Modulus")
        .def(py::init<std::uint64_t>())
        .def_property_readonly("bit_count", &Modulus::bit_count)
        .def_property_readonly("value", &Modulus::value)
    ...
    py::class_<Plaintext>(m, "Plaintext")
        ...
        .def_property_readonly("capacity", &Plaintext::capacity)
        .def_property_readonly("coeff_count", &Plaintext::coeff_count)
        .def_property_readonly("significant_coeff_count", &Plaintext::significant_coeff_count)
        .def_property_readonly("nonzero_coeff_count", &Plaintext::nonzero_coeff_count)
        .def("to_string", &Plaintext::to_string)
        .def("is_ntt_form", &Plaintext::is_ntt_form)
        .def_property_readonly("parms_id", py::overload_cast<>(&Plaintext::parms_id, py::const_))
    ...
    py::class_<Ciphertext>(m, "Ciphertext")
        ...
        .def_property_readonly("coeff_modulus_size", &Ciphertext::coeff_modulus_size)
        ...
        .def_property_readonly("parms_id", py::overload_cast<>(&Ciphertext::parms_id, py::const_))
    ...
    py::class_<SecretKey>(m, "SecretKey")
        ...
        .def_property_readonly("parms_id", py::overload_cast<>(&SecretKey::parms_id, py::const_))
    ...
    py::class_<PublicKey>(m, "PublicKey")
        ...
        .def_property_readonly("parms_id", py::overload_cast<>(&PublicKey::parms_id, py::const_))
    ...
    py::class_<KSwitchKeys>(m, "KSwitchKeys")
        ...
        .def_property_readonly("size", &KSwitchKeys::size)
        .def_property_readonly("parms_id", py::overload_cast<>(&KSwitchKeys::parms_id, py::const_))
    ...
    py::class_<RelinKeys, KSwitchKeys>(m, "RelinKeys")
        ...
        .def_property_readonly("size", &RelinKeys::KSwitchKeys::size)
        .def_property_readonly("parms_id", py::overload_cast<>(&RelinKeys::KSwitchKeys::parms_id, py::const_))
    ...
    py::class_<GaloisKeys, KSwitchKeys>(m, "GaloisKeys")
        ...
        .def_property_readonly("size", &GaloisKeys::KSwitchKeys::size)
        .def_property_readonly("parms_id", py::overload_cast<>(&GaloisKeys::KSwitchKeys::parms_id, py::const_))
    ...
    py::class_<KeyGenerator>(m, "KeyGenerator")
        ...
        .def_property_readonly("secret_key", &KeyGenerator::secret_key)
    ...
    py::class_<CKKSEncoder>(m, "CKKSEncoder")
        .def(py::init<const SEALContext &>())
        .def_property_readonly("slot_count", &CKKSEncoder::slot_count)
